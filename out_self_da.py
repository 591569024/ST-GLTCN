...
parser.add_argument('--gpu', type=str, default="2", help='use which gpu 0, 1 or 2')
...
# model params
param_dict['model'] = ['GLSTModel', 'glst_net_lstm_double_attention',
...
param_dict['header'] = {'len_global': 10, 'len_local': 10, 'neighbor_size': 15, 'res': 5,
                        'cnn': 5, 'lr': 8, 'BN': 5, 'start_time': 10, 'end_time': 10, 'time': 20, 'rmse':15, 'mape': 15}
...
if __name__ == '__main__':
    ...
    param_dict['train_data'] = [data[name] for name in ['g_vacation_train', 'g_hour_train', 'g_dayOfWeek_train', 'g_weather_train',
                            ...
                            't_weather_train', 't_continuous_external_train', 'global_flow_train',
    ...
    param_dict['test_data'] = [data[name] for name in ['g_vacation_test', 'g_hour_test', 'g_dayOfWeek_test', 'g_weather_test',
                           ...
                           't_weather_test', 't_continuous_external_test', 'global_flow_test',
