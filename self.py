...
# model params
param_dict['model'] = ['GLSTModel', 'glst_net',
...
# file params
param_dict['header'] = {'len_global': 10, 'len_local': 10, 'neighbor_size': 15, 'res': 5, 'cnn': 5,
                        'lr': 8, 'BN': 5, 'start_time': 10, 'end_time': 10, 'time': 20, 'rmse':8, 'mape': 8}
...
if __name__ == '__main__':
    ...
    if param_dict['dataset'] == 'bj_taxi':
        ...
        param_dict['test_data'] = [data[name] for name in
                                   ['g_vacation_test', 'g_hour_test', 'g_dayOfWeek_test', 'g_weather_test',
